...
module.exports = exports = function patchPlugin(schema /*, schemaOptns*/ ) {
  ...
  schema.methods.patch = function patch(updates, done) {
    ...
    async.waterfall([
       ...
       * @description call perform pre(save/patch) logics
      ...
      function beforePatch(next) {
        //obtain before hooks
        const before = (this.beforePatch || this.beforeUpdate);
       ...
       * @name afterPatch
       * @function afterPatch
       * @description call perform after(save/patch) logics
      ...
      function afterPatch(instance, next) {
        //obtain after hooks
        const after = (instance.afterPatch || instance.afterUpdate);
